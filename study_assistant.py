...
def main():
    ...
    while(True):
        ...
        if mode == "quiz":
            ...
            # Set all the variables needed to create the chats that will run the quiz and feedback
            ...
            quiz.run_quiz(quiz_chat, evaluation_chat, specific_topic, total_questions)
        ...
        # Control how the program will be run if the study mode is selected
            ...
            # Run study until the user decides that they are done
            study.run_study(study_chat)
